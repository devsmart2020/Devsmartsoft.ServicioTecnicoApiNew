...
{
    public sealed class UbicacionRepository : BaseRepository<Ubicacion>, IUbicacionRepository
    {
        #region Fields
        ...
        #region Ctor
        public UbicacionRepository(DbServiciotecnicoContext context) : base(context)
        {
